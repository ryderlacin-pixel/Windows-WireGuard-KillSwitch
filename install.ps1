# ================================================================
# WireGuard + WARP Kill Switch - FULL AUTOMATIC SETUP (v11.0)
# ================================================================
...
$monitorContent = @"
# WireGuard Kill Switch - Monitor v11.0 (auto-generated by install.ps1)
...
function Repair-EssentialFirewall {
    ...
    $essential = @(
        @{ N='KS-DNS-Block';     A='netsh advfirewall firewall add rule name="KS-DNS-Block" dir=out action=block protocol=UDP remoteport=53 enable=yes' },
        @{ N='KS-DNS-Block-TCP'; A='netsh advfirewall firewall add rule name="KS-DNS-Block-TCP" dir=out action=block protocol=TCP remoteport=53 enable=yes' },
...
if ($taskXml) {
    ...
    Set-ItemProperty "HKLM:\SOFTWARE\WGKillSwitch" "Version"       "11.0"                              -Force
...
Log "install.ps1 v11.0 completed"
Write-Host ""
if ($warnings -eq 0) {
    Write-Host "================================================================" -ForegroundColor Green
    Write-Host "  INSTALL COMPLETE - SYSTEM FULLY PROTECTED (v11.0)            " -ForegroundColor White
    Write-Host "================================================================" -ForegroundColor Green
} else {
