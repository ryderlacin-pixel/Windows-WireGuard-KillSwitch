...
| Script | Purpose |
|--------|---------|
| `scripts/publish-releases.ps1` | Create/update releases (v10.x-v15.2.9); use `-Only v15.2.9` for one tag |
| `scripts/github-visibility.ps1` | Topics, repo description, Discussions, v15.2.9 release, profile bio |
