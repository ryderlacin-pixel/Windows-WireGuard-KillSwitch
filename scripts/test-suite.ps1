...
Write-Host '  Kill Switch FULL TEST SUITE (v15.2.3)' -ForegroundColor Cyan
Write-Host '========================================' -ForegroundColor Cyan
