...
Write-Host '  Kill Switch FULL TEST SUITE (v15.2.8)' -ForegroundColor Cyan
Write-Host '========================================' -ForegroundColor Cyan
