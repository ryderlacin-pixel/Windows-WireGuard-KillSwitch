...
Assert-True ($raw -match 'dns-lockdown-guard\.ps1') 'repair v15 dns-lockdown guard chain'
Assert-True ($raw -match 'network-privacy-guard\.ps1') 'repair v15 network-privacy guard chain'
