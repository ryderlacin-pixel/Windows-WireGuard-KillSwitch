...
Write-Host '  Kill Switch FULL TEST SUITE (v15.1)' -ForegroundColor Cyan
Write-Host '========================================' -ForegroundColor Cyan
...
Assert-True ($libFiles.Count -ge 8) 'lib/ has 8+ modules (v15.1 split)'
